      ...
      >
        <div className="max-w-full mx-auto px-4 py-16">
          <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-xl p-6">
            <h2 className="text-2xl font-semibold text-gray-800 mb-8">Prácticas Iniciales</h2>
            ...
            <div className="mt-6 flex justify-end">
              <button 
                ...
                onClick={() => navigate('/NuevaPractica')}
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
                </svg>
                Agregar práctica inicial
              </button>
            </div>
          </div>
        </div>
...
export default PracticaInicial;